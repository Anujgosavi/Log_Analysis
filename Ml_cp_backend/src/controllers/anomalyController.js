...
function buildSlackMessage(anomalyType, anomalyData) {
    if (anomalyType === 'SQL_INJECTION') {
        ...
        const message = anomalyData.parsedLogsResponse?.message || '⚠️ SQL injection attempt detected';
        ...
        const reconstructionError = (anomalyData.reconstruction_error || 0).toFixed(2);
